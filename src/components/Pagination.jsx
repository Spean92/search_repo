...
export const Pagination = () => {
    ...
    const renderPagination = (arr) => (
        <>
            <button data-page={page - 1} className={`${page === 1 ? "disabled" : null} prev page`}>Previous</button>
            {arr.map((el, i, a) => {
                return (
            ...
            <button data-page={page + 1} className={`${page === arr[arr.length-1] ? "disabled" : null} next page`}>Next</button>
        </>
    );
